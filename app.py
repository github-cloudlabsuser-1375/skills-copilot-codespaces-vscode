def calculator():
    ...
    - Supports percentage calculation using a single input.

    Raises:
    - ValueError: If the user inputs non-numeric values for numbers or an invalid choice for the operation.
    """
    while True:
        print("\nSelect operation:")
        print("1. Add")
